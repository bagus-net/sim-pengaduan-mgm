                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register-create') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="number" class="form-control @error('nik') is-invalid @enderror"  value="{{ old('nik') }}"  name="nik" required="">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="number" class="form-control @error('name') is-invalid @enderror" name="telp" required="">
